...
RSpec.describe ShoppingCartItemsController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      ShoppingCartItem.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: shopping_cart_item.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      shopping_cart_item = ShoppingCartItem.create! valid_attributes
      get :edit, params: {id: shopping_cart_item.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ShoppingCartItem" do
        expect {
          post :create, params: {shopping_cart_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {shopping_cart_item: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested shopping_cart_item" do
        shopping_cart_item = ShoppingCartItem.create! valid_attributes
        put :update, params: {id: shopping_cart_item.to_param, shopping_cart_item: new_attributes}, session: valid_session
      ...
      it "redirects to the shopping_cart_item" do
        shopping_cart_item = ShoppingCartItem.create! valid_attributes
        put :update, params: {id: shopping_cart_item.to_param, shopping_cart_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        shopping_cart_item = ShoppingCartItem.create! valid_attributes
        put :update, params: {id: shopping_cart_item.to_param, shopping_cart_item: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested shopping_cart_item" do
      shopping_cart_item = ShoppingCartItem.create! valid_attributes
      expect {
        delete :destroy, params: {id: shopping_cart_item.to_param}, session: valid_session
      }.to change(ShoppingCartItem, :count).by(-1)
    end
