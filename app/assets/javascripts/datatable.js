  ...
  if ($('.datatable')){
    var table_rules = {
      ...
      'items': { 'url': '/admin_panel/items',
                'columns': [ { 'searchable': true, 'orderable': true, 'data': 'id', 'targets': 0 },
                             { 'searchable': true, 'orderable': true, 'data': 'supplier_code', 'targets': 1 },
                             { 'searchable': true, 'orderable': true, 'data': 'name', 'targets': 2 },
                             { 'searchable': false, 'orderable': false, 'data': 'picture', 'targets': 3 },
                             { 'searchable': true, 'orderable': false, 'data': 'short_description', 'targets': 4 },
                             { 'searchable': false, 'orderable': true, 'data': 'unit_price', 'targets': 5 },
                             { 'searchable': false, 'orderable': true, 'data': 'discount', 'targets': 6 },
                             { 'searchable': false, 'orderable': true, 'data': 'buying_price', 'targets': 7 },
                             { 'searchable': false, 'orderable': true, 'data': 'quantity', 'targets': 8 },
      ...
      'orders': { 'url': '/admin_panel/orders',
                'columns': [ { 'searchable': true, 'orderable': true, 'data': 'id', 'targets': 0 },
                             ...
                             { 'searchable': false, 'orderable': true, 'data': 'delivery_at', 'targets': 11 },
                             { 'searchable': false, 'orderable': true, 'data': 'created_at', 'targets': 12 },
                             { 'searchable': false, 'orderable': false, 'data': 'actions', 'targets': 13 } ] },
