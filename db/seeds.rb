...
schedule_attributes = { monday_start_at: '11:00', monday_end_at: '19:30',
                        tuesday_start_at: '12:00', tuesday_end_at: '19:30',
                        wednesday_start_at: '13:00', wednesday_end_at: '19:30',
                        thursday_start_at: '14:00', thursday_end_at: '19:30',
...
clinics = [{ name: 'ABVC', email: 'info@abvc.ae', location_attributes: { city: 'Al Barsha' } },
           ...
           { name: 'UAIRPORT PET CLINIC',
             ...
             picture: 'https://lh6.googleusercontent.com/aa1cZl4XuKkqW24qm4ZWhtgyY1nHhvPvflmbdr81OgDyCnbmr2l0GS2WfaArsqcDYN4FDogYFR4-dU1uw0n9=w2560-h1379' },
           { name: 'UUVCA Bay Area Veterinary Specialists & Emergency Hospital',
             location_attributes: { city: 'Haharina St, 74, Storozhnytsya' },
             picture: 'https://lh4.googleusercontent.com/mbopp8kot2Ke4KGZLh8rtCAxK2s2uOuG9RbdJ0UwnGHe5XQkwaQHk6MDxvWxxsypFy2W3HeNI4fHJsQ0MXJM=w2560-h1379' },
           { name: 'UThe Country Vet',
             location_attributes: { city: 'Radyshcheva St, 11А, Uzhhorod' },
             picture: 'https://lh4.googleusercontent.com/sVGpeP3mj7y129LHX_kB9t_-1vopTqsUArR8fmVvcVbuC6avGvW8mNZYiqEqF8EM-uexfhfXX5syqceJcW1k=w2560-h1379' },
           { name: 'UNewport Harbor Animal Hospital',
             location_attributes: { city: 'Secheni St, 48, Uzhhorod' },
             picture: 'https://lh3.googleusercontent.com/G2lcSHRuo27Nr3RcE8PCaouog3dxK-IdLgxrNeeDlB0FPFKSK8V--CZPXTNN2SpoHMWUpMlc51r8KYq4CJ9n=w2560-h1379' },
           { name: 'URose City Veterinary Hospital',
             location_attributes: { city: 'Lermontova St, 9А, Uzhhorod' },
             picture: 'https://lh5.googleusercontent.com/zw9-RVGzMnMa9F0kz7KP0iY7GZcRODVepE4rpMb0D2c8JhW4DABCKnaVUH4lPjzbH3UBaHREe6ylLpXRyZPt=w2560-h1379' },
           { name: 'UCityVet',
             location_attributes: { city: 'Druhetiv St, 81-83, Uzhhorod' },
             picture: 'https://lh6.googleusercontent.com/3p89Py_Ctm_REyl1IMcMdSxhVh40Hpr3u2LbeSdLBTySEJuYuKSdlIBbvm3nmR5qIE90b4WAy1xmvCnqJfSq=w2560-h1379' },
           { name: 'URed Hill Animal Health Center',
             location_attributes: { city: 'Brodlakovycha St, 1, Uzhhorod' },
             picture: 'https://lh3.googleusercontent.com/IY-1CWtTt5tLCsQVb4hklbdDLrgL6Li_pcVdJD7q0gLOqa9vxs9N6rg4BtnKNM1Imw6Sj_yVdg6_sDSTvu7O=w2560-h1379' },
           { name: 'USpayToday Neuter Now',
             location_attributes: { city: 'Strilnychna St, 100, Uzhhorod' },
             picture: 'https://lh3.googleusercontent.com/o8Mw4w6XAVfb2cjCcuSaDN8YirXbAeWhZHn0Vrc81NLe49MNwFIlejvx9--XwoXkv1SrULjGK3eWAyVtRmLz=w2560-h1379' },
           { name: 'UCanton Animal Hospital',
             location_attributes: { city: 'Tekhnichna St, 16/1, Uzhhorod' },
             picture: 'https://lh3.googleusercontent.com/cxfDZCnjcVwwoHrB3_sReCQrByytWG7WD955CzQHFJaoeN_JSxsr8YQ89weVHjYE4y45DsnYQ-fQGeo5FgI1=w2560-h1379' },
           { name: 'UGold Coast Mobile veterinary Service',
             location_attributes: { city: 'Hranitna St, 67, Uzhhorod' },
             picture: 'https://lh3.googleusercontent.com/Z0uFk7MZjUTJB5SFj4vA3-1d0pm9-CCFe8_ahLdDvYDpqlKZi8p1Mrtij34T3wBsKhrBJmOC7xcO-bcMpHmx=w2560-h1379' },
           { name: 'URippowam Animal Hospital',
             location_attributes: { city: 'Dokuchajeva St, 1-6, Uzhhorod' },
             picture: 'https://lh6.googleusercontent.com/3l7ZCLwoyanMcSdbqHR-6NM0dTJNi9RnUTPnlnxdhZWyy5RugDRj0dCjnTbTQwy9zTo973eUWOe8rP0cixMF=w2560-h1379' }]

if Clinic.count.zero?
  clinics.each do |c|
    Clinic.create(name: c[:name], email: c[:email], mobile_number: c[:mobile_number],
                  is_emergency: [true, false].sample, remote_picture_url: c[:picture],
