...
ActiveRecord::Schema.define(version: 20181227134303) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.integer "unread_commented_orders_count", default: 0, null: false
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.boolean "is_active", default: true
    t.index ["item_brands_id"], name: "index_items_on_item_brands_id"
...
#   Unknown type 'order_item_status' for column 'order_status_flag'
  ...
  create_table "shopping_cart_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "recurssion_intervals_id"
    t.index ["item_id"], name: "index_shopping_cart_items_on_item_id"
    t.index ["recurssion_intervals_id"], name: "index_shopping_cart_items_on_recurssion_intervals_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "unread_commented_appointments_count", default: 0, null: false
    t.string "last_transaction_ref"
    t.datetime "last_transaction_date"
    t.integer "commented_orders_count", default: 0, null: false
    t.integer "unread_commented_orders_count", default: 0, null: false
  ...
  add_foreign_key "items", "item_brands", column: "item_brands_id"
  ...
  add_foreign_key "order_items", "recurssion_intervals", column: "recurssion_intervals_id"
  ...
  add_foreign_key "shopping_cart_items", "recurssion_intervals", column: "recurssion_intervals_id"
